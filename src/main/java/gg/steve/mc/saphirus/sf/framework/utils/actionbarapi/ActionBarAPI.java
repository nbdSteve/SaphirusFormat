package gg.steve.mc.saphirus.sf.framework.utils.actionbarapi;
...
//            e.printStackTrace();
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(SaphirusFormat.getInstance(), duration + 1);
        }
        ...
        while (duration > 40) {
            ...
            }.runTaskLater(SaphirusFormat.getInstance(), (long) duration);
        }
    }
